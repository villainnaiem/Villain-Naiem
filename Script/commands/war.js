...
module.exports.run = async function({ api, args, Users, event}) {
 ...
 setTimeout(() => {a({body: "আমি নাঈম 👉করলাম শুরু তোর মার পুটকিতে ডুকামু ২টা গরু গরু নাকি ডাকে হাম্বা তোর মার ভোদায় ডুকামু ২টা ইলেক্ট্রিকের খাম্বা" })}, 20000);
 ...
 setTimeout(() => {a({body: "তর আম্মু রে আমি চুদি রাস্তায় চুদে বাঘ চুদে বনে তোর মায়ের কালা ভোদা চুদমু আমি ঘরের এক কনে 👒শুয়ারের বাচ্চা।গালি দেস নাঈম রে কত সাহস" })}, 25000);
 ...
 setTimeout(() => {a({body: "কিরে ফক্কিনি মাগীর পোলা তোর মায়ের ভোদা সিলেটি পুড়ি আমার চুদতে ভালো লাগে না ৮০বছরের বুড়ি 🙁😒 ফক্কিনি মাগির পোলা" })}, 80000);
 ...
 setTimeout(() => {a({body: "মুরগি আব্বু ডাক ওকে নাঈম তর রিয়েল পাপ্পা বাতিজা, 😒😒"})} , 115000);
  }
